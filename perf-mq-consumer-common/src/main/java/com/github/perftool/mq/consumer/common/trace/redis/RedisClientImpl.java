...
import com.github.perftool.mq.consumer.common.trace.redis.functional.SyncCommandCallback;
...
public class RedisClientImpl implements TraceReporter {
    ...
    public void reportTrace(TraceBean traceBean) {
        try {
            ...
            set("consumer-traceid:" + traceBean.getTraceId(), mapper.writeValueAsString(traceBean));
        } catch (Exception e) {
